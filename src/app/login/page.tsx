...
const LoginPage = () => {
    ...
    return (
        <main
            className="min-h-screen w-full bg-background relative overflow-hidden flex items-center justify-center p-4">
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-0 left-1/4 w-[500px] h-[500px] rounded-full bg-primary/10 blur-[120px]"/>
                <div
                    className="absolute bottom-0 right-1/4 w-[500px] h-[500px] rounded-full bg-primary/5 blur-[120px]"/>
                <div
                    ...
                    <div className="surface-glass card-glow rounded-2xl border border-border p-8 md:p-10">
                        ...
                        <header className="mb-8">
                            <div className="flex justify-between">
                                ...
                                <div
                                    className="inline-flex items-center gap-2 text-xs uppercase tracking-widest text-primary mb-3">
